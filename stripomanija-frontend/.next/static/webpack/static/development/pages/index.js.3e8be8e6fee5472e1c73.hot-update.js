...
var LoginModal = function LoginModal(_ref2) {
  ...
  var _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_5__["useState"])(null),
      validationMsg = _useState4[0],
      setValidationMsg = _useState4[1];
  ...
  return __jsx(_components_GenericModal_GenericModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    className: "btn btn-primary",
    onClick: function onClick() {
      return sendRequest(_util_url__WEBPACK_IMPORTED_MODULE_8__["baseUrl"] + _util_routes__WEBPACK_IMPORTED_MODULE_9__["routes"].authenticate.path, user, setValidationMsg);
    },
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
function sendRequest(url, reqBody, setValidationMsg) {
...
//# sourceMappingURL=index.js.3e8be8e6fee5472e1c73.hot-update.js.map