...
var LoginModal = function LoginModal(_ref2) {
  ...
  return __jsx(_components_GenericModal_GenericModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    className: "btn btn-primary",
    onClick: function onClick() {
      sendRequest(_util_url__WEBPACK_IMPORTED_MODULE_8__["baseUrl"] + _util_routes__WEBPACK_IMPORTED_MODULE_9__["routes"].authenticate.path, user, setValidationMsg, setIsInvalid);
...
function routeIfAuthenticated() {
  Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(function () {
    ...
    if (localStorage.getItem(jwt)) {
      router.push(_util_routes__WEBPACK_IMPORTED_MODULE_9__["navbarRoutes"].katalozi.path);
    } else {
      router.push(_util_routes__WEBPACK_IMPORTED_MODULE_9__["navbarRoutes"].home.path);
    }
  }, []);
}
...
//# sourceMappingURL=index.js.37960ea589c66a41bbd6.hot-update.js.map