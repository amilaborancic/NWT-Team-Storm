...
var RegistrationModal = function RegistrationModal(_ref) {
  ...
  return __jsx(_components_GenericModal_GenericModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    onClick: function onClick() {
      return handleRegistrationRequest(_util_url__WEBPACK_IMPORTED_MODULE_8__["baseUrl"] + _util_routes__WEBPACK_IMPORTED_MODULE_9__["routes"].register.path, user, setValidationMsg, setIsInvalid);
    },
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
function handleRegistrationRequest(url, reqBody, setValidationMsg, setIsInvalid) {
  axios__WEBPACK_IMPORTED_MODULE_7___default.a.post(url, reqBody).then(function (response) {
    setValidationMsg(null);
    setIsInvalid(false);
    next_router__WEBPACK_IMPORTED_MODULE_10___default.a.push(_util_routes__WEBPACK_IMPORTED_MODULE_9__["navbarRoutes"].katalozi.path);
...
//# sourceMappingURL=index.js.5c83a462adb6c8cc0416.hot-update.js.map